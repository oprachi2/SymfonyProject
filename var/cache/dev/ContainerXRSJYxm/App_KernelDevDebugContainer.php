...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function get_Container_Private_TwigService()
    {
        ...
        $instance->addGlobal('project_name', 'Prachi Blog');
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('feVJOHRi5N', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $d = ($this->privates['vich_uploader.metadata_reader'] ?? $this->getVichUploader_MetadataReaderService());
        $e = ($this->services['vich_uploader.upload_handler'] ?? $this->getVichUploader_UploadHandlerService());

        $b->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('attachments', $c, $d, $e));
        $b->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('thumbnail', $c, $d, $e));
        $b->addEventSubscriber(new \Symfony\Bridge\Doctrine\SchemaListener\PdoCacheAdapterDoctrineSchemaSubscriber([]));
        $b->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('attachments', $c, $d, $e));
        $b->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('attachments', $c, $d, $e));
        $b->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('thumbnail', $c, $d, $e));
        $b->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('thumbnail', $c, $d, $e));
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('EasyCorp\\Bundle\\EasyAdminBundle\\Event\\BeforeEntityPersistedEvent', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\CommentEventSubscriber'] ?? $this->load('getCommentEventSubscriberService'));
        }, 1 => 'setComment'], 0);
        $instance->addListener('EasyCorp\\Bundle\\EasyAdminBundle\\Event\\BeforeEntityUpdatedEvent', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\CommentEventSubscriber'] ?? $this->load('getCommentEventSubscriberService'));
        }, 1 => 'updateComment'], 0);
        $instance->addListener('EasyCorp\\Bundle\\EasyAdminBundle\\Event\\BeforeEntityPersistedEvent', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\PostEventSubscriber'] ?? $this->load('getPostEventSubscriberService'));
        }, 1 => 'setPost'], 0);
        $instance->addListener('EasyCorp\\Bundle\\EasyAdminBundle\\Event\\BeforeEntityUpdatedEvent', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\PostEventSubscriber'] ?? $this->load('getPostEventSubscriberService'));
        }, 1 => 'updatePost'], 0);
    ...
    {
        return $this->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Registry\\CrudControllerRegistry'] = new \EasyCorp\Bundle\EasyAdminBundle\Registry\CrudControllerRegistry($this->getEnv('APP_SECRET'), [0 => 'App\\Controller\\Admin\\CategoryCrudController', 1 => 'App\\Controller\\Admin\\CommentCrudController', 2 => 'App\\Controller\\Admin\\PostCrudController', 3 => 'App\\Controller\\Admin\\UserCrudController']);
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Q7PXKxpW75', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('CcvXOFNmY1', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7-joC40iRZ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('97VjHfsvdh', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qRNM3U6z-5', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'uploads_path' => '/uploads/Attachments/',
            'tmp_path' => (\dirname(__DIR__, 4).'/var/tmp'),
